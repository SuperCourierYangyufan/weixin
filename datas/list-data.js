  ...
  
  {
    ...
    detail_content: '新垣结衣第一次走进中国人视野，应该是和三浦春马主演的《恋空》。虽然剧情集一切狗血桥段之大成，但还是让很多中国观众知道了这个眼神清澈、笑容美好的少女。',
  ...
  },
  {
    ...
    avatar: '/images/avatar/4.png',
    detail_content: '新垣结衣成为无数人老婆的《Legal High》系列，这部横空出世的喜剧常年蝉联B站日剧播放量冠军，是无数日剧粉的入圈之作。里面那个漂亮又固执，板正又蠢萌的小黛律师和发型极度偏分的雅人叔可谓是最佳 CP。。',
  ...
  },
  {
    ...
    avatar: '/images/avatar/4.png',
    detail_content: '其实，和阳光开朗荧幕形象不同，生活中的 Gakki 有着和宠物蜥蜴一样的内敛慢热属性。作为非科班出身的女优，能把傻白甜演得天然可爱，密集卖萌也不惹人厌烦，这本身就是演技的体现。',
